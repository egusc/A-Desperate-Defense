...
public class Pathfinder : MonoBehaviour
{
    ...
    Queue<Node> frontier = new Queue<Node>(); //holds available paths
    Dictionary<Vector2Int, Node> reached = new Dictionary<Vector2Int, Node>(); //Holds whether node has been explored
